...
//   thirteen, fourteen, fifteen, sixteen, seventeen, eighteen, nineteen];
  ...
  button.addEventListener("click", ask);
    ...
    //  selected_images =images[random_index]
    //  document.getElementById("").scr = ./${selected_images}
    

// let answers = ["It is certain", "It is decidely so.", "Yes definitely.",
// "Without a doubt.", "Yes you may rely on it.", "As I see it, yes.", 
//  "Most Likely.", "Outlook good.", "Yes.", "Signs point to yes.", "Try again.", 
...
// let answersLength = 20
// function ask(){
//     let randomNumber = Math.floor(Math.random()* answersLength +1);
//     let randomImage = document.getElementById("myImg").scr = ./images/magic8ball_${randomNumber}.png

// }

// const answers = document.querySelctor
//     function answers()
//     let a = Math.floor(Math.random()answers.length);
//     let img = magic8ball [a];